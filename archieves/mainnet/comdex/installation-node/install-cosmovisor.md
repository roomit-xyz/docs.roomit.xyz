...
Create file in **${HOME}/conf/cosmovisor-env,** this config was included in shell profile before ${HOME}/.zhrc or ${HOME}/.bashrc you can refer [installation-node](../../../../mainnet/akash/installation-node/ "mention")
