...
#  gravityd q distribution rewards gravity1ssduj8c0cc8kquljvw3ygq9hduvcysnf9wkp3k gravityvaloper1ssduj8c0cc8kquljvw3ygq9hduvcysnf590lmz -o json --home /app/grav/.gravity --node tcp://127.0.0.1:16700 |  jq '.rewards[] | select(.denom=="ugraviton")|.amount'
...
#  gravityd q distribution validator-outstanding-rewards gravityvaloper1ssduj8c0cc8kquljvw3ygq9hduvcysnf590lmz -o json --home /app/grav/.gravity --node tcp://127.0.0.1:16700
...
if [ `printf "%.0f \n" ${CHECK_BALANCES}` -gt 1000000 ]
then
   WILL_DELEGATE_BALANCES=$((${CHECK_BALANCES}-${HOLD}))
   if [ ${WILL_DELEGATE_BALANCES} -gt 1000000 ]
   then
      ...
      echo "`date` Balances for staking < 1"
   fi
   curl 
else
